...
def test(encoded: np.array):

    print(decode(encoded)+"inside test")

if __name__=="__main__":
    filepath = "img.png"
    image = cv2.imread(filepath)
    encoded_np_image = encode(image, 'Welcome to HackTrick!!!!')
    decode_from_test = test(encoded_np_image)
    print(decode(encoded_np_image)+"inside main")
